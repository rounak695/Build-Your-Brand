...
const CodeVisual = () => (
  <div className="w-full h-full min-h-[140px] bg-black/60 rounded-xl border border-white/5 p-3.5 font-mono text-[9px] text-zinc-400 overflow-hidden shadow-2xl relative select-none">
    ...
    <div className="space-y-1 text-left">
      ...
      <p className="pl-2 text-zinc-500">// Generated by Accelerate Swarm</p>
...
function BentoCard({ id, title, desc, icon: Icon, span = 1 }: any) {
...
function SkillCard({ id, title, desc, tag, apps }: any) {
  const renderVisual = () => {
    switch (id) {
      case "mvp":
